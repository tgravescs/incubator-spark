...
In order to tune worker core/number/memory/queue etc. You need to export SPARK_WORKER_CORES, SPARK_WORKER_MEMORY, SPARK_WORKER_INSTANCES, SPARK_YARN_QUEUE e.g. by ./conf/spark-env.sh
